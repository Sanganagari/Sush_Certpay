...
public class Bureau_Login_Page {
	...
	@Keyword
	def verifyPaymentInRealTimeMonitor(String referenceNum,String lastName,String firstName,String paymentID){
		String paymentId=WebUI.getText(	findTestObject('Object Repository/BUREAU_LOGIN/PAYMENT_ID'))
