...
CustomKeywords.'pages.Quicksti.setAmountDetailsForMultiBureau'('0', paymentType, paymentAmount, comments, referenceNum, 
    quantity)

CustomKeywords.'utilities.SafeActions.safeType'(findTestObject('CERTPAY_QUICKSTI/Payment_Information_Page/PAYMENT_AMOUNT'), 
    paymentAmount2, 'Payment Amount', (([GlobalVariable.pageLoadTime]) as int[]))

CustomKeywords.'pages.Quicksti.setAmountDetailsForMultiBureau'('1', paymentType, paymentAmount2, comments, referenceNum2, 
    '3')
...
CardNumber = CustomKeywords.'pages.Quicksti.setUserPaymentDetails'(firstName, lastName, GlobalVariable.AMEX_Card)
