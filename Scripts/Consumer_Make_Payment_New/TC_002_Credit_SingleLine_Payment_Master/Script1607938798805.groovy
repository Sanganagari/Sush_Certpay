...
ExcelData data = findTestData('Data Files/Certpay/SingleBureau_SingleLine_Master')
...
CustomKeywords.'utilities.SafeActions.safeType'(findTestObject('MAKE_ PAYMENT/Home_ Page/BUREAU_CODE'), GlobalVariable.bureau_code, 'Bureau code', 
...
'Select \'Master\' from card type dropdown'
...
WebUI.scrollToElement(findTestObject('MAKE_ PAYMENT/Home_ Page/NEXT_BUTTON'), 3)
